...
INPUT_MAIN_LINE_WIDTH = 1.2
INPUT_BG_LINE_WIDTH = 2.0
OUTPUT_MAIN_LINE_WIDTH = 1.2
OUTPUT_BG_LINE_WIDTH = 2.0
...
def add_phase_lines(ax, tps, y_max, y_min=None):
    ...
    phase_labels = ["Encoding", "Maintaining", "Retrieval"]
    label_positions = [
...
if __name__ == "__main__":
    ...
    fig3.savefig(f"{FIG_DIR}/inputs_and_outputs.png", dpi=600)
    print(f"Figure 3 generated: {FIG_DIR}/inputs_and_outputs.png")
