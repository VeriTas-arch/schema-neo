...
base_colors, colors_rank1, colors_rank2, colors_rank3 = utils.get_color_single(
    X1, X2, X3
)
...
def plot_delay_pca_grid(color_rows, fig_name="pca_analysis_delay_stage_grid_all_ranks"):
    ...
    out_path = FIG_DIR / f"{fig_name}.pdf"
...
if __name__ == "__main__":
    ...
    plot_delay_pca_grid(
        [colors_rank1, colors_rank2, colors_rank3], fig_name="sfig_pca_different_color"
    )

    # examine each rank separately
    plot_delay_different_pc_grid(
        rank=1, color=colors_rank1, fig_name="sfig_pca_all_combinations_rank1"
    )
    plot_delay_different_pc_grid(
        rank=2, color=colors_rank2, fig_name="sfig_pca_all_combinations_rank2"
    )
    plot_delay_different_pc_grid(
        rank=3, color=colors_rank3, fig_name="sfig_pca_all_combinations_rank3"
    )
    # plot_delay_different_pc_grid(
    #     rank=1,
    #     color=colors_empty,
